...
<head>
    ...
    <<title>Skill Tracks - DataCamp</title>
        ...
        <div class="p-8 flex items-center justify-between" style="background:#05192D">
            <div>
                <div class="flex items-center gap-3 mb-3">
                    <h1 class="text-2xl font-bold text-white">Skill tracks</h1>
                    <span ... >⚡ Skill deep dive</span>
                </div>
                <p class="text-sm text-gray-300 max-w-lg">Acquire new skills fast in courses that combine short expert videos with immediate hands-on exercises.</p>
            </div>
