...
<div class="px-6 pt-8 pb-4">
    <h1 class="text-2xl font-medium mb-1">Katalog AI Agent</h1>
    <p class="text-sm text-white/50">Temukan tools, framework, dan library untuk membangun AI agent</p>
</div>
