        ...
        <div class="p-8 flex items-center justify-between" style="background:#05192D">
            <div>
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <span class="text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1" style="background:#3b82f6;color:white">
            ...
            <div class="hidden lg:block">
                <svg width="120" height="100" viewBox="0 0 120 100" fill="none">
                    <circle cx="60" cy="30" r="16" fill="none" stroke="#3b82f6" stroke-width="2"/>
                    <circle cx="30" cy="60" r="10" fill="none" stroke="#3b82f6" stroke-width="1.5" opacity="0.5"/>
                    <circle cx="90" cy="60" r="10" fill="none" stroke="#3b82f6" stroke-width="1.5" opacity="0.5"/>
                    <circle cx="60" cy="30" r="6" fill="#3b82f6"/>
                    <path d="M30 60 Q45 40 60 30 Q75 20 90 60" stroke="#3b82f6" stroke-width="1.5" fill="none" stroke-dasharray="4 2"/>
                    <text x="48" y="34" font-size="7" fill="white" font-weight="bold">ASSESS</text>
                </svg>
            </div>
        </div>
